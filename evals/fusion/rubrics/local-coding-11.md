...
Reject or revise: `||` treats an intentional empty array as absent and can grant tools unexpectedly. Preserve explicit empty arrays with nullish coalescing and add a test that empty allowedClientTools remains empty.
