...
Changing S0 after candidates are run invalidates paired comparisons and can overfit claims; select codex vs opus once through same proxy path and freeze until suite bump.
