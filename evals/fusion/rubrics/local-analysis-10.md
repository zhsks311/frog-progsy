...
Snapshot must be redacted for secrets, hash unredacted canonical config separately, include profile overlay identity, and never copy tokens into artifacts.
