...
Reject parity claim. Pilot is for calibration only; defensible wording is local pilot signal or, after frozen suite, improvement over strongest local single-model baseline under registered rules.
