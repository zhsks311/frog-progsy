...
Support repeated --profile flags or JSON/manifest input, keep comma form only as legacy convenience, document escaping limitations, and test repeated flags.
