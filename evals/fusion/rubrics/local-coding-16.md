...
Redact secrets/tokens/headers, strip model/profile identifiers and panel traces for quality judge, keep proxy-stage traces only for proxyContract grader.
