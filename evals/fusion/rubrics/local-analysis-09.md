...
It is internal evidence gathering for pre-final stages; exposing it as a real client tool would require user tool loop ownership and could violate stateless proxy boundaries.
