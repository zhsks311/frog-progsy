...
Reasoning emphasis can hide coding/analysis/protocol regressions in the aggregate; require per-category breakdown and no category drop beyond threshold plus proxyContract hard gate.
